...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="site-blocks-cover overlay" style="background-image: url('{{asset('assets/images/hero_1.jpg')}}');" data-aos="fade" data-stellar-background-ratio="0.5" data-aos="fade">
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-8 text-center" data-aos="fade-up" data-aos-delay="400">
            <h1 class="mb-4">SUITS ADVOCACIA</h1>
            <p class="mb-5">Soluções Jurídicas Eficazes</p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row no-gutters align-items-stretch align-items-center">
          <div class="col-lg-3 section-title">
            <div class="service-1-title h-100">
              <h2 class="text-black">Área de atuação</h2>
              <p>Escritório voltado em várias áreas.</p>
            </div>
          </div>
          <div class="col-lg-3">
    ...
    <div class="site-section section-3"> <div class="container"> <div
    class="row justify-content-center mb-5"> <div class="col-lg-6
    section-title text-center"> <h2>Outras Áreas</h2> </div> </div>
